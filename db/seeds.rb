...
vini_lausanne_stop = Stop.create(city:"lausanne", start_date:Date.new(2018,12,01), end_date:Date.new(2018,12,31), user:vini, photo: File.open(Rails.root.join("app", "assets", "images", "bordeaux.jpg")))
...
evan_lisbon_stop = Stop.create(city:"lisbon", start_date:Date.new(2018,12,01), end_date:Date.new(2018,12,07), user:evan, photo: File.open(Rails.root.join("app", "assets", "images", "lisbon.jpeg")))
...
towel_item = Item.create(user:evan, name: 'Travel Towel', description: "Blue towel, can fold up nicely, dries quickly, perfect for backpackers", photo: File.open(Rails.root.join("app", "assets", "images", "towel.jpeg")))
...
Listing.create(item: european_plug_item, stop: evan_amsterdam_stop)
Listing.create(item: book_harry_potter_philosopher_item, stop: evan_amsterdam_stop)
Listing.create(item: surf_board_item, stop: evan_lisbon_stop)
Listing.create(item: headphone_item, stop: evan_lisbon_stop)
...
Listing.create(item: towel_item, stop: evan_lausanne_stop)
Listing.create(item: flashlight_item, stop: evan_lausanne_stop)
Listing.create(item: sim_card_item, stop: evan_lausanne_stop)
